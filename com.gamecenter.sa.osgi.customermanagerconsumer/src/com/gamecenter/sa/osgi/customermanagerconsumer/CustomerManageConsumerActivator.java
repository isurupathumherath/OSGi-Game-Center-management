...
import com.gamecenter.sa.osgi.model.Customer;
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		do {
			...
			if(option == 0)
				...
				String message = gameCustomerManageService.updateCustomer(updatedName, updatedAddress, updatedNIC, updatedEmail, updatedMobileNumber, updatedNIC);
				if(message == null) {
